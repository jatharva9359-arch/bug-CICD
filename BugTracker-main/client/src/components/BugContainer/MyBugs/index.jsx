...
const BugTable = () => {
  ...
  const getAllBugs = (userId) => {
    fetch(apiUrl(`/bugs?user_id=${userId}`))
    .then((result) => result.json())
    .then((data) => {
      setAllBugs(data);
  ...
  return (
    ...
    <div className='mb-10 animate-slide-down'>
      <h1 className="text-5xl font-bold bg-gradient-orange bg-clip-text text-transparent">My Issues</h1>
      <p className="text-gray-600 dark:text-gray-400 mt-3 text-lg">View and manage your assigned issues</p>
